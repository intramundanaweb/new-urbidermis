jQuery(document).ready(function ($) {
    ...
    */
    ...
    $(".section-contact btn-round").mouseenter(function () {
        $(".wrapper.contact").animate({
            backgroundColor: '#87966e'
        }, 200)
        $(".section-contact btn-round").css('color', '#000')
    }).mouseleave(function () {
        $(".wrapper.contact").animate({
    ...
    $(".skin-buttons btn-round").mouseenter(function () {
        $(".wrapper.skin").animate({
            backgroundColor: '#b4714e'
        }, 200)
        $(".section-skin btn-round").css('color', '#000')
    }).mouseleave(function () {
        $(".wrapper.skin").animate({
    ...
    $(".section-reference btn-round").mouseenter(function () {
        $(".wrapper.reference").animate({
            backgroundColor: '#9dbfcc'
        }, 200)
        $(".section-reference btn-round").css('color', '#000')
    }).mouseleave(function () {
        $(".wrapper.reference").animate({
            backgroundColor: '#f6f5f1'
        }, 200)
