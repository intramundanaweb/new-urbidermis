                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <?php
                                      ...
                                      'container_id'     => 'navbar',
                                      'depth'            => 2,
                                      'container_class'  => 'menu justify-content-end py-lg-3 bg-beige-light',
                                      'menu_id'          => 'main-menu',
                                      'menu_class'       => 'navbar-nav flex-column h-100 nav-primary text-left justify-content-center px-lg-5 px-3',
                                    ...
                                    <a href="#" class="close-menu collapse closed">
                                        <span aria-hidden="true"
                                            class="color-black icon-menu-start text-white fs-3"></span>
                                    </a>
                                </div>
                            </div>
                        </div>
