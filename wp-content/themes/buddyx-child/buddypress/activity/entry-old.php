...
<li class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>"
    ...
    data-bp-activity="<?php if ( function_exists( 'bp_nouveau_edit_activity_data' ) ) { bp_nouveau_edit_activity_data(); } ?>">
    ...
    <div class="activity-item-head">
        ...
        <div class="activity-header">
            ...
            <!-- <p class="activity-date">
                <a
                    href="<?php //echo esc_url( bp_activity_get_permalink( bp_get_activity_id() ) ); ?>"><?php //echo bp_core_time_since( bp_get_activity_date_recorded() ); ?></a>
                <?php
