...
<div class="item-header-cover-image-wrapper">
	...
	<?php if ( ! bp_nouveau_groups_front_page_description($group) ) : ?>
		<div id="item-header-content">
			...
			<?php } else { ?>
				<p class="highlight group-status x"><strong><?php echo wp_kses( bp_nouveau_group_meta()->status, array( 'span' => array( 'class' => array() ) ) ); ?></strong></p>
			<?php } ?>
