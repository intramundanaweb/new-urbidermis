...
<div class="container-borderbotom mb-5 pb-3">
...
// if ( bp_has_profile( 'profile_group_id=' . bp_get_current_profile_group_id() ) ) :
	...
	<?php do_action( 'bp_before_profile_field_content' ); ?>
		...
		<h4><?php printf( __( "%s", "buddypress" ), bp_get_the_profile_group_name() ); ?></h4>
...
<?php
if ( bp_has_profile( 'profile_group_id=4' ) ) :
	while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
...
<?php
if ( bp_has_profile( 'profile_group_id=3' ) ) :
	while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
