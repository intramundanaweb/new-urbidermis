<template>
  <div
    ...
    :class="[dialogClass, $root.settings.customization.forms ? `am-form-${formType}-${formName}-${bookableType}` : '']"
  >
        ...
        <el-row class="am-confirm-booking-data" :gutter="24">
          ...
          <template v-for="(formField, key) in formsData[formName][bookableType].itemsDraggable">
            <component
              ...
              :class-identifier="`${formType}-${formName}-${bookableType}`"
              :formField="formField"
              ...
              >
                <el-form-item
                  ...
                  :class="[
                    ...
                    $root.settings.customization.forms ? `am-custom-${formType}-${formName}-${bookableType}` : ''
                  ]"
                >
                  ...
                  <el-select
                    ...
                    v-model="appointment.bookings[0].customFields[customField.id].value"
                    :popper-class="$root.settings.customization.forms ? `am-dropdown-${formType}-${formName}-${bookableType}` : ''"
                    placeholder=""
                    clearable
        ...
        <el-row :gutter="24" class="am-confirm-booking-payment">
          ...
          <el-col :sm="columnsLg">
            <payment-method-form-field
              ...
              :appointment="appointment"
              :classIdentifier="`${formType}-${formName}-${bookableType}`"
              :form-field="formsData[formName][bookableType].itemsStatic"
            ...
            <div class="am-confirmation-booking-cost" v-if="!packageData">
              ...
              >
                <el-collapse
                  ...
                  :class="$root.settings.customization.forms ? `am-block-${formType}-${formName}-${bookableType}`: ''"
                >
              ...
              >
                ...
                <el-col :sm="14" :xs="14">
                  ...
                  >
                    <el-form-item
                      :style="bookableType === 'event' && !useGlobalCustomization ? getBookableColor(false) : {}"
                      :class="$root.settings.customization.forms ? `am-input-${formType}-${formName}-${bookableType}`: ''"
                      :error="errors.coupon"
                      prop="couponCode"
                    >
                      <el-input
              ...
              <!-- Deposit -->
              <el-row
                class="am-confirmation-deposit" :gutter="24" v-if="depositAmount > 0 && getPaymentGateway() !== 'onSite'"
                :style="{'color': bookable.color, 'background-color': bookableType === 'event' && !useGlobalCustomization ? '#E8E8E8' : ''}"
              >
                <el-col :span="12">
              ...
              <el-row
                :gutter="24" v-if="depositAmount > 0 && getPaymentGateway() !== 'onSite'"
                :style="{'color': bookable.color, 'background-color': bookableType === 'event' && !useGlobalCustomization ? '#E8E8E8' : ''}"
              >
                <el-col :span="12">
    ...
    <div id="am-spinner" class="am-booking-fetched" v-show="!fetched && !paid">
      <h4
        ...
        :style="{color: bookableType === 'event' ? formsData.globalSettings.formTextColor : formsData[$options.name][bookableType].globalSettings.formTextColor}"
      >
