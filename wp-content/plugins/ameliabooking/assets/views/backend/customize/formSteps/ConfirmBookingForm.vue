  ...
  >
      ...
      <div class="am-package-header">
        ...
        <div class="am-package-header-image-data-wrapper">
          ...
          <div class="am-package-image">
            ...
            <span :style="{'background-color': customization.primaryColor}">
      ...
      <el-row>
        <el-col :sm="24">
          ...
          <div class="am-confirmation-booking-cost">
            ...
            <div class="am-confirmation-total" :style="{backgroundColor: `${customization.primaryColor}1a`}">
              <!-- Total Price -->
              <el-row :gutter="24">
                <el-col :span="12">
                  <p :style="{color: customizationForm.formTextColor}">
    ...
    <div class="dialog-footer">
      ...
      <div
        v-if="customizeDisplay === 'event'"
        class="el-button el-button--primary"
        :style="{backgroundColor: eventColor, borderColor: '#ffffff', color: customization.textColorOnBackground}"
...
export default {
  ...
  mixins: [imageMixin, dateMixin, priceMixin, formsCustomizationMixin],
