  ...
  <div class="am-categories" :class="{'editable': editable}">
    ...
    <div class="am-categories-wrapper" :class="{'editable': editable}">
      ...
      <div class="am-categories-headline">
        <span class="am-back" :style="{color: customization.primaryColor}">
        ...
        <h3 :style="{color: customization.primaryColor}">{{ category.name }}</h3>
      </div>
      <!-- /Back button & Category Name -->
        ...
        >
          ...
          <div class="am-categories-service">
            ...
            <div
              ...
              :style="{backgroundColor: `${customization.primaryColor}b3`}"
            >
              <span class="am-categories-service-title" :style="{color: customization.textColorOnBackground}">
                {{ service.name }}
              </span>
              <el-button :style="{color: customization.textColorOnBackground, borderColor: customization.textColorOnBackground}">
                <template v-if="!languageShortCode">
            ...
            <div
              ...
              :style="service.pictureFullPath ? {backgroundImage: `url(${service.pictureFullPath})`} : {backgroundImage: `linear-gradient(90deg, ${customization.primaryColor}a6 0%, ${customization.primaryColor} 100%)`}"
            >
            </div>
            <!-- /Service Background Image -->
