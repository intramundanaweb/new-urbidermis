      ...
      <el-tab-pane name="1">
        ...
        <div class="am-catalog" :style="{ 'fontFamily': customization.font }">
          <catalog-list-form
            ...
            :customization-form="formTypeData.catalogListForm.globalSettings"
      ...
      <el-tab-pane name="2">
        ...
        <div class="am-catalog" :style="{ 'fontFamily': customization.font }">
          <category-list-form
            ...
            :language-short-code="languageShortCode"
            :customization="customization"
            :customization-form="formTypeData.categoryListForm.globalSettings"
      ...
      <el-tab-pane name="1">
        ...
        <div class="am-catalog" :style="{ 'fontFamily': customization.font }">
          <category-service-form
            ...
            :language-short-code="languageShortCode"
            :customization="customization"
            :customization-form="formTypeData.categoryServiceForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              ...
              <div class="am-step-booking am-active-picker" :style="{ 'fontFamily': customization.font }">
                ...
                <select-service-form
                  ...
                  :language-short-code="languageShortCode"
                  :customization="customization"
                  :customization-form="formTypeData.selectServiceForm.globalSettings"
                ...
                <calendar-date-time-form
                  ...
                  :language-short-code="languageShortCode"
                  :customization="customization"
                  :customization-form="formTypeData.calendarDateTimeForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              ...
              <div class="am-step-booking am-active-picker" :style="{ 'fontFamily': customization.font }">
                ...
                <recurring-setup-form
                  ...
                  :language-short-code="languageShortCode"
                  :customization="customization"
                  :customization-form="formTypeData.recurringSetupForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              ...
              <div class="am-step-booking" :style="{ 'fontFamily': customization.font }">
                ...
                <recurring-dates-form
                  ...
                  :language-short-code="languageShortCode"
                  :customization="customization"
                  :customization-form="formTypeData.recurringDatesForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              ...
              <div class="am-step-booking" :style="{ 'fontFamily': customization.font }">
                ...
                <confirm-booking-form
                  ...
                  :customization-form="formTypeData.confirmBookingForm[customizeDisplay].globalSettings"
            ...
            <template slot="bookingTemplates">
              ...
              <div class="am-step-booking" :style="{ 'fontFamily': customization.font }">
                ...
                <congratulations-form
                  ...
                  :customization="customization"
                  :customize-display="customizeDisplay"
                  :customization-form="formTypeData.congratulationsForm[customizeDisplay].globalSettings"
      ...
      <el-tab-pane name="1">
        ...
        <div class="am-catalog" :style="{ 'fontFamily': customization.font }">
          <category-package-form
            ...
            :language-short-code="languageShortCode"
            :customization="customization"
            :customization-form="formTypeData.categoryPackageForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              <div class="am-step-booking am-active-picker" :style="{ 'fontFamily': customization.font }">
                ...
                <package-setup-form
                  ...
                  :language-short-code="languageShortCode"
                  :customization="customization"
                  :customization-form="formTypeData.packageSetupForm.globalSettings"
            ...
            <template slot="bookingTemplates">
              <div class="am-step-booking" :style="{ 'fontFamily': customization.font }">
                ...
                <package-list-form
                  ...
                  :customization="customization"
                  :customization-form="formTypeData.packageListForm.globalSettings"
