        ...
        >
          ...
          >
            <v-date-picker
              ...
              :style="item.isEditing ? { backgroundColor: customizationForm.formInputColor, color: customizationForm.formInputTextColor, borderColor: selectInputFocus ? customization.primaryColor : '#a4b1c4' } : {color: customizationForm.formTextColor}"
            >
            </v-date-picker>
          </el-col>
            ...
            >
              <el-option
                ...
                :style="{
                  ...
                  color: slot.name === item.slot ? customization.primaryColor : customizationForm.formDropdownTextColor,
          ...
          <el-col :lg="4" :sm="4" class="am-recurring-row-action" :class="item.isEditing ? 'is-editing' : ''">
            ...
            <div v-if="item.editable" class="am-edit-element">
              <i
                ...
                style="font-size: 16px"
                :style="item.isEditing ? {color: customizationForm.formTextColor, backgroundColor: customization.primaryColor} : {color: customizationForm.formTextColor}"
