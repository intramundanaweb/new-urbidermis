    ...
    <el-collapse v-model="calendarCollapse" accordion>
      ...
      >
        <template slot="title">
          <span
            :style="{
              color: customizationForm.formTextColor,
              whiteSpace: 'nowrap',
              overflow: 'hidden',
        ...
        <p v-if="formField.timeZoneVisibility" class="am-timezone" :style="{ 'color': customizationForm.formTextColor, margin: '0 0 16px'}">
        ...
        <v-date-picker
          ...
          :is-expanded=true
          :is-inline=true
          :style="{ color: customizationForm.formTextColor, fontFamily: customization.font }"
