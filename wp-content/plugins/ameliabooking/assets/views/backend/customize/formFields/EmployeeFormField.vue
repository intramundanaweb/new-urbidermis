    ...
    >
      <el-option
        ...
        :style="{
          ...
          color: labelAnyEmployee.value === employee ? customization.primaryColor : customizationForm.formDropdownTextColor,
      ...
      <el-option
        ...
        :style="{
          backgroundColor: customizationForm.formDropdownColor,
          color: item.name === employee ? customization.primaryColor : customizationForm.formDropdownTextColor,
          fontFamily: customization.font
        }"
      >
      </el-option>
