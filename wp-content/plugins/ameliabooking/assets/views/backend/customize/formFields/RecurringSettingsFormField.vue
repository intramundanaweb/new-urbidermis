            ...
            >
              <el-option
                ...
                :style="{
                  ...
                  color: item.name === recurringRepeat ? customization.primaryColor : customizationForm.formDropdownTextColor,
          ...
          <el-form-item>
            ...
            >
              <el-option
                ...
                :style="{
                  backgroundColor: customizationForm.formDropdownColor,
                  color: item.name === recurringInterval ? customization.primaryColor : customizationForm.formDropdownTextColor,
                  fontFamily: customization.font
                }"
              >
              </el-option>
          ...
          <el-form-item>
            ...
            >
              <el-checkbox-button
                ...
                :style="{backgroundColor: weekDaysSelected.indexOf(index) > -1 ? customization.primaryColor : customizationForm.formInputColor, color: customizationForm.formInputTextColor}"
              >
                {{weekDay.label}}
              </el-checkbox-button>
            </el-checkbox-group>
          ...
          <el-form-item>
            ...
            >
              <el-option
                ...
                :style="{
                  backgroundColor: customizationForm.formDropdownColor,
                  color: item.name === monthSelected ? customization.primaryColor : customizationForm.formDropdownTextColor,
                  fontFamily: customization.font
                }"
              >
              </el-option>
