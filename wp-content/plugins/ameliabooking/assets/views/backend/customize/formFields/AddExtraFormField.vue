<template>
  ...
  >
              ...
              >
                <el-option
                  ...
                  :style="{
                    ...
                    color: item.name === extra ? customization.primaryColor : customizationForm.formDropdownTextColor,
            ...
            <el-form-item>
              ...
              >
                <el-option
                  ...
                  :style="{
                    backgroundColor: customizationForm.formDropdownColor,
                    color: item.name === quantity ? customization.primaryColor : customizationForm.formDropdownTextColor,
                    fontFamily: customization.font
                  }"
                >
                </el-option>
    ...
    <div
      ...
      :style="{color: customization.primaryColor, backgroundColor: customization.primaryColor + '12'}"
