<template>
  ...
  >
    <div class="am-package" :style="{backgroundColor: customization.primaryColor + '0d', borderColor: customization.primaryColor}">
      <el-row>
        ...
        <el-col :span="8" class="am-package-price">
          <p class="am-large-text" :style="{color: customization.primaryColor}">
            $125.00
          </p>
          <p class="am-discount-text" :style="{color: customization.primaryColor}">
            <template v-if="!languageShortCode">
      ...
      <el-row class="am-package-services">
        ...
        <el-col :span="3">
          <p class="am-package-appointment-number" :style="{color: customization.primaryColor}">
            x9
          </p>
        </el-col>

        <el-col :span="2" class="am-package-book">
          <i class="el-icon-right" :style="{color: customization.primaryColor}"></i>
        </el-col>
      </el-row>
    </div>
    <!-- Edit Dialog -->
